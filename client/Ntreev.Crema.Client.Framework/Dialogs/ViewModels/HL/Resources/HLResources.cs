...
namespace Ntreev.Crema.Client.Framework.Dialogs.ViewModels.HL.Resources
{
    internal class HLResources
	{
		...
		{
			var fileRef = prefix + "." + name;

			var s = typeof(HLResources).Assembly.GetManifestResourceStream(fileRef);
			if (s == null)
			...
			IHLTheme theme)
		{
            ...
            hlm.RegisterHighlighting(theme, "Json", new[] {".json"}, "Json.xshd");
