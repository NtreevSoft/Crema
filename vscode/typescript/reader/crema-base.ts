import reader = require("./crema-reader");
...
export abstract class CremaTable<T extends CremaRow> {
    ...
    protected setRelations<U extends CremaRow>(childName: string, childs: Array<U>, setChildsAction
        : (target: T, childName: string, childs: Array<U>) => void): void {
